...
class ToonilyClient(MangaClient):

    base_url = urlparse("https://toonily.com/")
    ...
    def __init__(self, *args, name="Toonily", **kwargs):
    ...
    def mangas_from_page(self, page: bytes):
        ...
        container = bs.find("div", {"class": "page-listing-item"})

        cards = container.find_all("div", {"class": "item-thumb"})
    ...
    def chapters_from_page(self, page: bytes, manga: MangaCard = None):
        ...
        container = bs.find("div", {"id": "tab-chapter-listing"})
